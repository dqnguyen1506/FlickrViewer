...
namespace FlickrViewer
{
   public partial class FlickrViewerForm : Form
   {
      ...
      // http://www.flickr.com/services/apps/create/apply
       private const string KEY = "62e37173eea1ae947557e5afe660490a";
      ...
      private async void searchButton_Click( object sender, EventArgs e )
      {
        ...
        //privacy_filter=1. Use the inputTextBox.Text.Replace(" ", ",") for tag.
         var flickrURL = string.Format("https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key={0}&tags={1}&tag_mode=all&per_page=500&privacy_filter=1",KEY,inputTextBox.Text.Replace(" ",",") );
         ...
         if ( imagesListBox.SelectedItem != null )
         {
            string selectedURL =
               ( ( FlickrResult) imagesListBox.SelectedItem ).URL;
                ...
                WebClient flickrClientSelected = new WebClient();
                //IFFY//Invoke the the WeClient DownloadDataTaskAsync method to get byte array called imageBytes that contains the photo (from selectedURL) and await the results. 
                Task<byte[]> imageBytes = flickrClientSelected.DownloadDataTaskAsync(selectedURL);
                await imageBytes;
                //Create a MemoryStream object from imagesBytes
                MemoryStream memStream = new MemoryStream(imageBytes.Result);
